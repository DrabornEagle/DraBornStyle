  ...
  return (
    <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.content}>
      <View style={styles.hero}>
        ...
        <LinearGradient colors={['rgba(4,6,11,0.12)', 'rgba(4,6,11,0.62)', 'rgba(4,6,11,0.98)']} locations={[0, 0.42, 1]} style={StyleSheet.absoluteFill} />
...
const styles = StyleSheet.create({
  ...
  hero: { height: 360, borderRadius: 28, overflow: 'hidden', borderWidth: 1, borderColor: colors.border }, heroImage: { ...StyleSheet.absoluteFill, width: '100%', height: '100%' },
