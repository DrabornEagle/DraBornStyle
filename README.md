...
| 🟡 | v0.0.19 | Miami UI altyapısı, modern ikonlar ve işletme profili formu eklendi, telefonda test edilecek |
| ⬜ | v0.0.20 | İşletme adı, logo, kapak görseli, adres, konum ve çalışma saatleri detaylı bağlanacak |
...
Genel uygulama tasarımı Miami temalı modern profesyonel UI olacaktır.

- Koyu lacivert premium arka plan
- Neon turkuaz ve Miami pembe vurgu renkleri
- Büyük okunur başlıklar
- Yuvarlatılmış glass-card yapısı
- Berber / kuaför / salon işletmelerine güven veren temiz görünüm
...
cp .env.example .env
npm install
npm run drabornstyle_start -- --lan
```
...
npm run drabornstyle_android
npm run drabornstyle_web
npm run drabornstyle_typecheck
```
