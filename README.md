...
| 🟡 | v0.0.24 | Miami Night Pro tema ve rol bazlı yetki özeti eklendi, telefonda test edilecek |
...
Krem/beyaz tasarım göz yorduğu için v0.0.24 içinde tema Miami Night Pro yapısına çekildi.

- Krem/beyaz ana tema kaldırıldı.
- Koyu lacivert, neon turkuaz, Miami pembe ve turuncu vurgu renkleri kullanıldı.
- Kartlar siyah değil; lacivert cam panel görünümünde tutuldu.
- Ağır ikon kütüphanesi yok; hafif badge sistemi devam ediyor.
- `Yetki Özeti` kartı eklendi.
- Her rol seçildiğinde o role ait temel yetki maddeleri gösterilir.
- İşletme sahibi dışında kalan roller kendi temel panel kartına yönlenir.
